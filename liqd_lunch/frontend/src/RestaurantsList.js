              ...
              <div className="col-sm-8 col-md-6 col-lg-4">
                ...
                {this.state.restaurants.map( c  =>
                    <div className="py-3 form-group" key={c.pk}>
                        ...
                        <input type="range" ref={this.resistanceRef} className="custom-range w-100" defaultValue="0" min="0" max="10" id={"restaurant" + c.pk} onClick={(e)=>  this.handleResistanceCreate(e,c.pk) }></input>
                        <div className="d-flex justify-content-between">
                          <span>Nope</span>
                          <span>Yeah</span>
                        </div>
